...
void fifo::write (char c) {
	// TODO: Add wait condition is FIFO is FULL
	if (num_elements == size) wait(read_event);
...
char fifo::read () {
  ...
  last_time = sc_time_stamp();
	...
	// TODO: Add wait condition if FIFO is EMPTY
